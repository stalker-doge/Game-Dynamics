...
AObjectiveArea::AObjectiveArea()
{
	...
	Goal->OnComponentBeginOverlap.AddDynamic(this, &AObjectiveArea::OnOverlapBegin);
	RootComponent = Goal;
...
void AObjectiveArea::OnOverlapBegin(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
...
// Called every frame
void AObjectiveArea::Tick(float DeltaTime)
{
